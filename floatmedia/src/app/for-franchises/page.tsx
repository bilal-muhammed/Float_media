...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] overflow-hidden">
      {/* ═══════ HERO ═══════ */}
      <section className="relative flex items-center overflow-hidden py-20 md:py-44">
      ...
      {/* ═══════ THE CHANGE ═══════ */}
      <SectionDivider />
      <section className="section-full-bleed py-16 md:py-24">
      ...
      {/* ═══════ ROLLOUT ═══════ */}
      <SectionDivider />
      <section id="rollout" className="relative py-16 md:py-24 overflow-hidden" style={{ isolation: 'isolate' }}>
        ...
        <div className="relative mx-auto max-w-[1200px] px-6">
          <FadeIn>
            ...
            <h2 className="section-title mt-4 text-white" style={{ textShadow: '0 2px 20px rgba(0,0,0,0.9), 0 0 40px rgba(0,0,0,0.6)' }}>
              <SplitText text="From first call to a live network." />
            </h2>
            <p className="mt-5 text-[14px] leading-[1.75] text-[#a1a1aa] max-w-xl" style={{ textShadow: '0 1px 12px rgba(0,0,0,0.9)' }}>
          ...
          <StaggerContainer className="mt-14 gap-4 sm:grid-cols-2 lg:grid-cols-4 items-stretch" delay={100}>
            {[
              ...
              <div key={i} className="group relative flex flex-col h-full">
                ...
                <div className="flex-1 flex flex-col border border-[#27272a] bg-[#18181b]/80 backdrop-blur-sm p-5 transition-all duration-500 hover:-translate-y-1 hover:border-[#0891b2]/30 hover:shadow-[0_20px_50px_-15px_rgba(8,145,178,0.15)]">
                  <div className="flex h-10 w-10 items-center justify-center bg-[#27272a] transition-all duration-300 group-hover:bg-[#0891b2]/10 group-hover:scale-110">
      ...
      {/* ═══════ CONTACT ═══════ */}
      <SectionDivider />
      <section id="contact" className="section-full-bleed py-16 md:py-24">
        <div className="mx-auto max-w-3xl px-6">
          <FadeIn>
